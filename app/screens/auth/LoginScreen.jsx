  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.roleRow}>
        {
          generateOtp ? <>
            <TouchableOpacity onPress={() => verifyOtpI()} style={[styles.roleBtn]}>
              <Text>Verify</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => resendOtp()} style={[styles.roleBtn]}>
              <Text>Resend OTP</Text>
            </TouchableOpacity>
          </>
           : (
            <TouchableOpacity onPress={() => triggerOtp()} style={[styles.roleBtn]}>
              <Text>Generate OTP</Text>
            </TouchableOpacity>
           )
        }
        <TouchableOpacity onPress={() => navigation.navigate('Signup')} style={[styles.roleBtn]}>
          <Text>Signup</Text>
        </TouchableOpacity>
      </View>
    </View>
